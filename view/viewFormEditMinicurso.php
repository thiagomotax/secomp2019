<?php
    ...
    if (isset($_SESSION['user_id'])) {
      ...
      $stmtMinicursos = $MinicursosDAO->runQuery("SELECT * FROM minicursos WHERE codMinicurso = ".$_REQUEST['codMinicurso']."");
      $stmtMinicursos->execute();
      $RowMinicursos = $stmtMinicursos->fetch(PDO::FETCH_ASSOC);
      ...
      <div class="content-wrapper">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-body">
                <form class="form-horizontal" id="minicurso-form" method="POST">
                  <legend>Editar minicurso / <?php echo $RowMinicursos['nomeMinicurso']; ?> </legend>
                  <input type="hidden" name="acao" value="editar">
                  <input type="hidden" name="codMinicurso" id="codMinicurso" value="<?php echo $RowMinicursos['codMinicurso']; ?>">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label class="col-lg-2 control-label">Nome</label>
                        <div class="col-lg-10">
                          <input class="form-control" type="text" name="nome" placeholder="Nome do minicurso" value="<?php echo $RowMinicursos['nomeMinicurso']; ?>" required autocomplete="off">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input class="form-control" type="text" name="ministrante" placeholder="Ministrante do minicurso" value="<?php echo $RowMinicursos['ministranteMinicurso']; ?>" required autocomplete="off">
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input class="form-control" type="text" name="vagas" maxlength="2" placeholder="Vagas do minicurso" value="<?php echo $RowMinicursos['vagasMinicurso']; ?>" required autocomplete="off">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <div class="col-lg-11 col-lg-offset-1">
                          <textarea class="form-control" name="informacoes" id="textArea" rows="3" required autocomplete="off"><?php echo $RowMinicursos['informacoesMinicurso']; ?></textarea>
                  ...
                  <div class="row">
                    <div class="col-md-12 text-center">
                      <div class="form-group">
                        ...
                        <button id="btnEditarMinicurso" class="btn btn-primary" type="submit">Editar</button>
                      </div>
                    </div>
                  </div>
                </form>

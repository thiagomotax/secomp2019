...
<html>
  ...
  <body class="sidebar-mini fixed">
                ...
                '<ul class="sidebar-menu">
                  ...
                  <li class="treeview"><a href="#"><i class="mdi mdi-school mdi-lg"></i> <span>Minicursos</span><i class="fa fa-angle-right"></i></a>
                    <ul class="treeview-menu">
                      ...
                      <li class="active"><a href="viewRelatoriosMinicursos.php"><span class="mdi mdi-file-pdf mdi-lg"></span> Relatórios Minicursos</a></li>
                    </ul>
                  </li>
            ...
            <div class="card">
              <div class="card-body">
                <form class="form-horizontal" target="_blank" name="formRelatorio" id="relatorios-form" method="POST">
                  <div class="row">
                    <div class="col-md-12">
                      <h4>Inscrições nos Minicursos</h4>
                      <?php
                        while ($RowMinicursos = $stmtMinicursos->fetch(PDO::FETCH_ASSOC)) {
                          echo 
                          '
                            <div class="animated-radio-button">
                                <label><input type="radio" id="minicurso" data-nome="'.$RowMinicursos['nomeMinicurso'].'" name="minicursoRD" value="'.$RowMinicursos['codMinicurso'].'" checked><span class="label-text">'.$RowMinicursos['nomeMinicurso'].'</span>
                                </label>
                            </div>';
                        }
                      ?>
    ...
    <script src="../assets/js/custom/relatorios.min.js"></script>
  </body>
</html>
<?php
  }else {

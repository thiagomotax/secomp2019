...
<html>
  <head>
    ...
    <title>VIII Secomp - Minicursos</title>
  </head>
            ...
            if($RowUsuarios['nivelUsuario'] == 0){
                ...
                '<ul class="sidebar-menu">
                  ...
                  <li class="treeview"><a href="#"><i class="mdi mdi-school mdi-lg"></i> <span>Minicursos</span><i class="fa fa-angle-right"></i></a>
                    <ul class="treeview-menu">
                      <li class="active"><a href="viewMinicursos.php"><span class="mdi mdi-format-list-bulleted mdi-lg"></span> Listar Minicursos</a></li>
              ...
              echo
                '<ul class="sidebar-menu">
                  ...
                  <li class="active"><a href="viewMinicursos.php"><i class="mdi mdi-format-list-bulleted mdi-lg"></i> <span>Minicursos</span></a></li>
                        ...
                        <table class="table table-hover table-bordered table-custom" id="sampleTable">
                          <thead>
                            <tr>
                              <th width="5%">#</th>
                              <th width="20%">Nome</th>
                              <th width="20%">Ministrante</th>
                              <th width="5%">Vagas</th>
                              <th width="5%">Vagas restantes</th>
                              <th width="45%">Informações</th>
                              <th width="5%">Ações</th>
                            </tr>
                          </thead>
                          <tbody>

                ...
                '<ul class="sidebar-menu">
                  ...
                  <li class="treeview"><a href="#"><i class="mdi mdi-plus mdi-lg"></i> <span>Extras</span><i class="fa fa-angle-right"></i></a>
                    <ul class="treeview-menu">
                      ...
                      <li class="active"><a href="viewFormCadExtra.php"><span class="mdi mdi-playlist-plus mdi-lg"></span> Cadastrar Extra</a></li>
      ...
      <div class="content-wrapper">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-body">
                <form id="extra-form" class="form-horizontal" method="POST">
                  <legend>Cadastrar extra</legend>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input class="form-control" type="text" name="nome" placeholder="Nome do extra" required>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-12 text-center">
                      <div class="form-group">
                        ...
                        <button id="btnCadastrarExtra" class="btn btn-primary" type="button">Cadastrar</button>
                      </div>
                    </div>
                  </div>
                </form>
